<template>
  <div class="text-xl font-bold flex py-20 justify-between">
    <nuxt-link to="/">Grzegorz Hadala&mdash;Product Designer</nuxt-link>
    <nav class="flex flex-row space-x-8 2xl:sticky">
